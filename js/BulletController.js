class BulletController {
    constructor(position, directtion, bulletName) {
        ...
        // this.bullet.trackSprite(this.spriteName,x, y);
        ...
        this.sprite.angle = (Math.atan(directtion.x / -directtion.y)*180/3.14);
        this.sprite.angleOffset = 90;
        // console.log(directtion);
        this.sprite.body.velocity = directtion.setMagnitude(BulletController.BULLET_SPEED);
    }
}
